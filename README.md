# BalderHub Package ``balderhub-waveform``
...
```
python -m pip install balderhub-waveform
```

# Check out the documentation

If you need more information, 
[checkout the ``balderhub-waveform`` documentation](https://hub.balder.dev/projects/waveform).
